...
func (i *Implementation) RemoveFromBlacklist(ctx context.Context, request *accessAPI.RemoveFromBlacklistRequest) (*accessAPI.RemoveFromBlacklistResponse, error) {
